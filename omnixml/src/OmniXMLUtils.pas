(*:XML helper unit. Contains routines to convert data, retrieve/set data of
   ...
   History:
     ...
     1.29a: 2012-01-13
       - (af) Added optional useBoolStrs parameter to SetNodeTextBool.
     1.29: 2011-02-07
...
type
  ...
  function SetNodeTextBool(parentNode: IXMLNode; nodeTag: string;
    value: boolean; useBoolStrs: boolean = false): IXMLNode;
...
function SetNodeTextBool(parentNode: IXMLNode; nodeTag: string;
  value, useBoolStrs: boolean): IXMLNode;
begin
  Result := SetNodeText(parentNode,nodeTag,XMLBoolToStr(value,useBoolStrs));
end; { SetNodeTextBool }
